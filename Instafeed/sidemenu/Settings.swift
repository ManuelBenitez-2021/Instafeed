...
class Settings: UIViewController {
    ...
    @IBAction func privacytapped(_ sender: Any) {
        let move = storyboard?.instantiateViewController(withIdentifier: "PrivacyViewController") as! PrivacyViewController
    ...
    @IBAction func buttons_actions(_ sender: Any) {
        ...
        case 30:
            print("your activity")
            let move = storyboard?.instantiateViewController(withIdentifier: "YourActivityViewController") as! YourActivityViewController
            navigationController?.pushViewController(move, animated: false)
        default:
            break
        }
